...
#Question 3 
prop_entry_no_vending <- (round((sum(table_distinct_stations$vending == "NO" & table_distinct_stations$entry == "TRUE") /                sum(table_distinct_stations$vending == "NO")), 3))*100
```
